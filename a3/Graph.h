...
namespace gdwg {
    ...
    public:
        ...
        /*
         * Graph own nodes and edges(stored shared pointer)...     nodes contain src and dst edges vectors(weak pointer)
         *
         * Graph own nodes and nodes own edges is a better structure...
         * use set is for faster find... but I mess it up
         */
